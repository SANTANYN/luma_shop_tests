...
class WomanCatalogPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        print(self.woman_store_element)
    ...
    def open_woman_bottoms_page(self):
        woman_store_element = self.find_page_element(self.WOMAN_PAGE)
        woman_bottoms_element = self.find_page_element(self.WOMAN_BOTTOM_PAGE)
    ...
    def open_woman_bottoms_pants(self):
        woman_store_element = self.find_page_element(self.WOMAN_PAGE)
        woman_bottoms_element = self.find_page_element(self.WOMAN_BOTTOM_PAGE)
        woman_bottoms_pants_element = self.find_page_element(self.WOMAN_BOTTOM_PANTS_PAGE)
    ...
    def open_woman_bottoms_shorts(self):
        woman_store_element = self.find_page_element(self.WOMAN_PAGE)
        woman_bottoms_element = self.find_page_element(self.WOMAN_BOTTOM_PAGE)
        woman_bottoms_shorts_element = self.find_page_element(self.WOMAN_BOTTOM_SHORTS_PAGE)
